...
public class Emergencyapp {
    ...
    public Emergencyapp(String emergencyapp) {

        this._emergencyapp = emergencyapp;
    }

    public Emergencyapp(String name, String _phone_number, String category) {
